...
import { createSuperAdmin } from "@/utils/superAdmin/createSuperAdmin";
import DotCircleLoader from "@/components/DotCircleLoader";
import { createAdmin } from "@/utils/superAdmin/createAdmin";
...
const CreateAdmin = () => {
  ...
  const onSubmit = async (data) => {
    ...
    console.log("Response from createAdmin:", res); // Debugging log
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md m-4  ">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          >
            {loading ? <DotCircleLoader /> : "Create Super Admin"}
          </button>
        </form>
      </div>
    </div>
